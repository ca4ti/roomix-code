...
function viewFormHome($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf, $arrLang)
{
    ...
    $intro	= "<big><big><big><big>RoomX</big></big></big></big><br>The Hotel / Hospital module for Elastix. <br>Version : ".$version['version'].".";
