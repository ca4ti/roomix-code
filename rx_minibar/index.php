...
function viewFormMiniBar($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf, $arrLang)
{
    ...
    $arrFormMiniBar = createFieldForm($arrLang);
