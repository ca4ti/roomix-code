...
class paloSantoAddRoom {
    var $_DB;
    var $errMsg;

    function paloSantoAddRoom(&$pDB)
    {
    ...
    function getNumAddRoom($filter_field, $filter_value)
    {
        $where = "";
        if(isset($filter_field) & $filter_field !="")
            $where = "where $filter_field like '$filter_value%'";

        $query   = "SELECT COUNT(extension) FROM users $where";
