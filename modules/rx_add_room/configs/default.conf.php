<?php
  ...
  +----------------------------------------------------------------------+
  $Id: default.conf.php,v 1.1 2010-04-03 04:04:58 Franck Danard franckd@agmp.org Exp $ */
  $DocumentRoot = (isset($_SERVER['argv'][1]))?$_SERVER['argv'][1]:"/var/www/html";
  require_once("$DocumentRoot/libs/misc.lib.php");
    global $arrConf;
    global $arrConfModule;

    $arrConfModule['module_name']       = 'rx_add_room';
    $arrConfModule['templates_dir']     = 'themes';
    //ex1: $arrConfModule['dsn_conn_database'] = "sqlite3:///$arrConf[elastix_dbdir]/base_name.db";
    $arrConfModule['dsn_conn_database'] = "mysql://root:".obtenerClaveConocidaMySQL('root')."@localhost/asterisk";
