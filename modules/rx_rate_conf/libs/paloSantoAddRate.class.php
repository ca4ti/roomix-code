<?php
  ...
  +----------------------------------------------------------------------+
  $Id: paloSantoAddRate.class.php,v 1.1 2010-06-16 08:06:16 Franck Danard franckd@agmp.org Exp $ */
class paloSantoAddRate {
    var $_DB;
    var $errMsg;

    function paloSantoAddRate(&$pDB)
    {
    ...
    function getNumAddRate($filter_field, $filter_value)
    {
        $where = "";
    ...
    function getAddRate($limit, $offset, $filter_field, $filter_value)
    {
        $where = "";
        if(isset($filter_field) & $filter_field !="")
            $where = "where $filter_field like '$filter_value%'";
        ...
        $result=$this->_DB->fetchrate($query, true);
