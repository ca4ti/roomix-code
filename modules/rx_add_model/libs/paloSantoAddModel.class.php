<?php
  ...
  +----------------------------------------------------------------------+
  $Id: paloSantoAddModel.class.php,v 1.1 2010-04-05 09:04:41 Franck Danard franckd@agmp.org Exp $ */
class paloSantoAddModel {
    var $_DB;
    var $errMsg;

    function paloSantoAddModel(&$pDB)
    {
    ...
    function updateModel($sTabla, $arrValores ){
