...
class paloSantoRoomList {
    ...
    function getConfig()
    {
        $query   = "SELECT locked FROM config";
	...
	function getRoomFree()
    {
        $query   = "SELECT id,room_name FROM rooms WHERE `free` = '1' ORDER BY extension ASC";
